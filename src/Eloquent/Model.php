<?php namespace Dialpath\Eloquent;

use Illuminate\Database\Eloquent\Model as EloquentModel;
use Illuminate\Database\QueryException;
use Dialpath\DialpathException;
...
class Model extends EloquentModel {
	...
	public function save(array $options = [])
	{
		...
		{
			throw $this->dialpathExceptionIf([self::DUPLICATED_KEY, self::CANNOT_SAVE], $e);
		}
	}
	...
	public function delete()
	{
		...
		{
			throw $this->dialpathExceptionIf(self::CANNOT_DELETE, $e);
		}
	}

	protected function dialpathExceptionIf($mySqlErrorNumber, QueryException $e)
	{
		...
		switch ($actualErrorNumber)
		{
			case self::DUPLICATED_KEY:
				return new DialpathException($this->getDuplicatedKeyErrorMessage());

			case self::CANNOT_DELETE:
				return new DialpathException($this->getCannotDeleteErrorMessage());

			case self::CANNOT_SAVE:
				return new DialpathException($this->getCannotSaveErrorMessage($e));
		}
	}
