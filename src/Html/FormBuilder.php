...
class FormBuilder extends BaseFormBuilder
{
	 ...
	 * @return Dialpath\Html\FormBuilder
	 */
	...
	{
		$open = config('dialpath.formAttributes', []);
	...
	protected function prepareField(&$field, array $attributes = [], &$decoration = [])
	{
		...
		$configAttributes = config('dialpath.fieldAttributes', []);
	...
	protected function getLabel(&$field, $type = null)
	{
		...
		$labelAttributes = array_merge(config('dialpath.labelAttributes', []), $labelAttributes);
		unset($field['label']);
